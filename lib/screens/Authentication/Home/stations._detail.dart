...
class StationDetailsPages extends StatelessWidget {
            ...
            children: [
              ...
              Center(
                child: ElevatedButton.icon(
                  onPressed: () => _deleteStation(station,context),
  ...
  Future<void> _deleteStation(Station station, BuildContext context) async {
    try {
      // Use stationId as the document ID for deletion
      await FirebaseFirestore.instance
          .collection("stations")
          .doc(station.stationId) // Use stationId here
          .delete();
